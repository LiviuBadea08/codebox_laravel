...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
                <h1 class="row justify-content-center font-sans font-bold text-4xl 36px" >Iniciar Sesion</h1>
                <div class="text-white font-sans font-bold bg-white">{{ __('Login') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="row mb-3">
                            <label for="email" class="col-md-4 col-form-label text-md-end text-base font-sans font-bold">{{ __('Email Address') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="password" class="col-md-4 col-form-label text-md-end font-sans font-bold">{{ __('Password') }}</label>
