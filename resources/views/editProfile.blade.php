        ...
        <section class="relative py-16 bg-blueGray-200">
            <div class="container mx-auto px-4">
                <div class="relative  min-w-0 break-words bg-white w-full mb-6 shadow-xl rounded-lg -mt-64">
                    ...
                    @method('patch')
                    @csrf
                        <div class="flex mt-5 items-center justify-between w-3/5">
                        ...
                        <div class="flex mt-3 items-center justify-between w-3/5">
                            <label class="w-40 block text-gray-500 font-bold md:text-right mb-1 md:mb-0 pr-4" for="inline-full-name">
                                Dirección 
                            </label>
                        ...
                        <div class="flex mt-3 mb-5 items-center justify-between w-3/5">
                            <label class="w-40 block text-gray-500 font-bold md:text-right mb-1 md:mb-0 pr-4" for="inline-full-name">
                                Acerca de mí
                            </label>
                            <textarea class="w-1/2 bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500 h-36" id="about" name="about">
                                {{ $user->about }}
                            </textarea>
                        </div>
