            ...
            <div class="container mx-auto px-4">
                <div class="relative  min-w-0 break-words bg-white w-full mb-6 shadow-xl rounded-lg -mt-96">
                    ...
                    <div class=" md:flex mt-5 items-center  justify-between w-11/12 ">
                            ...
                            type="url"  name="image" value="{{$event->image}}">
                        </div>
                        <div class="  mt-3 md:flex items-center  justify-between w-11/12 ">
                            <label class="w-40 block text-gray-500 font-bold md:text-right mb-1 md:mb-0 pr-4" for="inline-full-name">
                                Título
                            </label>
                            <input class="w-1/2 bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="inline-full-name" type="text"  name="name" value="{{$event->name}}">
                        </div>
                        ...
                        <div class="md:flex mt-3 mb-3 items-center justify-between w-11/12">
                            ...
                            <textarea class="w-1/2 bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500 h-36" id="about" name="description">{{$event->description}}</textarea>
                        </div>
