        ...
        <form class=" col-sm-4 p-4">
            ...
            <section class="flex space-x-2 justify-center pb-2">
                        <div class="marco1">
                            ...
                            <input type="file" id="image_uploads" name="image_uploads" accept=".jpg, .jpeg, .png" style="display:none" required value="{{$event->image}}">
                        </div>
            </section>
            ...
            <section class="flex space-x-2 justify-center">
                    <div>
                        ...
                        <input type="date" id="start" name="trip-start"  min="1001-01-01" max="2200-12-31" required value="{{$event->date}}">
                    </div>
                    <div>
                        <input type="time" name="hora" id="time" required value="{{$event->time}}">
                    </div>
            </section>
            <section id="container" class="flex space-x-2 justify-center py-6">
                ...
                <div class="contenido marco2">
                    <input type="number" placeholder="Maximo participantes" max="99" required value="{{$event->capacity}}"/>
                </div>
            </section>
            <div class="flex space-x-2 justify-center space-evenly">
                <button type="submit" method="update" class="inline-block px-6 py-2.5 bg-green-500 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-green-600 hover:shadow-lg focus:bg-green-600 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-green-700 active:shadow-lg transition duration-150 ease-in-out" onclick="return confirm ('Seguro que desea modificar este evento {{$event->name }}?')">Confirmar</button>
