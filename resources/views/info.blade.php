...
<body class="bg-gray-900 text-gray-100 ">
      ...
      <div
        ...
        <div class="flex flex-col justify-between">
          <div>
            ...
            <div class="text-gray-700 mt-8">
              Llámanos al<span> 93.77.77.77 </span> si lo prefieres!
            </div>
          </div>
          <div class="mt-8 text-center">
            <svg class="w-full" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
              ...
              <path
                ...
                transform="translate(-52 -162.63)" fill="#34D399" />
              <path
        ...
        <div class="">
          <div>
            <span class="uppercase text-sm text-gray-600 font-bold">Nombre y apellidos </span>
          ...
          <div class="mt-8">
            <button
              class="uppercase text-sm font-bold tracking-wide text-gray-100 p-3 rounded-lg w-full focus:outline-none focus:shadow-outline" style="background-color: #34D399;">
              Enviar Mensaje
            </button>
          </div>
        </div>
